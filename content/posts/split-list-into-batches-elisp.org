...
#+DESCRIPTION: A simple Emacs Lisp function that can be used to chop or group a list of things into batches of a maximum size, including examples of unit testing and boundary value analysis.
