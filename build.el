...
(defcli! build-site ()
         ...
         ;; Add custom keywords for post org headers
         (setq charge-org-keywords '("slug" "title" "date" "draft" "filetags" "description"
                                     "feature"))
           ...
           (charge-site
            ...
            (charge-route static-files
                          ...
                          :emit (lambda (destination particle _route _site)
                                  ...
                                  (let ((path (plist-get particle :path)))
                                    (if (file-directory-p path)
                                        (copy-directory path destination nil t t)
